...
## Project Structure
    ...
    ├── delivery_template_t_37891  # Django project configurations
...
1. Clone this repo and `cd delivery_template_t_37891`
...
2. Clone this repo and `cd delivery_template_t_37891`
